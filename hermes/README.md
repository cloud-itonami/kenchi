...
| profile | description |
|---|---|
| `yata-contrib-gate` | yata-contrib-gate: measures the member-contribution path (submit - sign - governor - commit) for the yataverse/kenchi membrane; reports one gap per tick. |
| `yata-georeg-ontology` | yata-georeg-ontology: real-estate registry ontology bot (kenchi + maps registry + otent observations). Fuses cadastre/construction/materials/rent/land-price/ten |
